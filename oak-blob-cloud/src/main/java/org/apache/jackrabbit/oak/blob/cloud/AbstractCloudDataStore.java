...
public abstract class AbstractCloudDataStore extends AbstractSharedCachingDataStore implements ConfigurableDataRecordAccessProvider, CloudDataStore {
    /**
     * The minimum size of an object that should be stored in this data store.
     */
    protected int minRecordLength = 16*1024;
    ...
    public void setBinaryTransferAccelerationEnabled(boolean enabled) {
        if (backend != null) {
            backend.setHttpUploadBinaryTransferAccelerationEnabled(enabled);
        }
    }
