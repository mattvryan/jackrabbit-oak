...
public class CompositeDataStoreTest {
    ...
    public void testRemoveDelegate() {
        ...
        cds.removeDelegate(delegate.getDataStore());
    ...
    public void testRemoveOneOfManyDelegates() {
        ...
        cds.removeDelegate(delegates.get(1).getDataStore());
        delegates.remove(1);
    ...
    public void testRemoveNonMatchingDelegate() {
        ...
        DataStoreProvider otherDsp = new InMemoryDataStoreProvider();
        cds.removeDelegate(otherDsp);
